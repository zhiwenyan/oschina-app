...
public final class RegexUtils {
     ...
     */
    public static boolean isMobileSimple(final String input) {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isMobileExact(final String input) {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isTel(final String input) {
     ...
     * @return {@code true}: 匹配<br>{@code false}: 不匹配
     */
    public static boolean isNumeber(final String input) {
    ...
    public static boolean isName(final String input) {
        return isMatch(RegexConstants.REGEX_NAME, input);
    }
    ...
    public static boolean isAddress(final String input) {
        return isMatch(RegexConstants.REGEX_ADDRESS, input);
    }
