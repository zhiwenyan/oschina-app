...
import com.steven.oschina.Setting;

/**
 * Description:
 * Data：7/19/2018-10:32 AM
 *
 * @author yanzhiwen
 */
    ...
    private static class KeyboardStatusListener implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        private void calculateKeyboardHeight(final int displayHeight) {
            ...
            if (isHandleByPlaceholder(isFullScreen, isTranslucentStatus,
                ...
                LogUtils.d(TAG, String.format("action bar over layout %s display height: %s",
            ...
            LogUtils.d(TAG, String.format("pre display height: %s display height: %s keyboard: %s ",
            ...
            if (keyboardHeight == this.statusBarHeight) {
                LogUtils.e(TAG, String.format("On global layout change get keyboard height just equal" +
        ...
        private void calculateKeyboardShowing(final int displayHeight) {
            ...
            if (isHandleByPlaceholder(isFullScreen, isTranslucentStatus,
                ...
                if (!isTranslucentStatus &&
                    ...
                    LogUtils.e(TAG, String.format("skip the keyboard status calculate, the current" +
            ...
            if (lastKeyboardShowing != isKeyboardShowing) {
                LogUtils.d(TAG, String.format("displayHeight %s actionBarOverlayLayoutHeight %s " +
