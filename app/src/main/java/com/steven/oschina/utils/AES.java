...
public final class AES {
    private static String AES_IV = BuildAppKey.AES_IV;
    private static String AES_KEY = BuildAppKey.AES_KEY;
    private static final String AES_MODE = BuildAppKey.AES_MODE;
