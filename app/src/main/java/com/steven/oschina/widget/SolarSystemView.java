...
public class SolarSystemView extends View implements Runnable {
    ...
    private ValueAnimator getAccelerateAnimator() {
        ...
        mAccelerateAnimator.addUpdateListener(animation -> mFlushRate = (( Float ) animation.getAnimatedValue()).intValue());
    ...
    private ValueAnimator getDecelerateAnimator() {
        ...
        mDecelerateAnimator.addUpdateListener(animation -> mFlushRate = (( Float ) animation.getAnimatedValue()).intValue());
